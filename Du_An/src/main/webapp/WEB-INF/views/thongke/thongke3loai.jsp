        ...
        <div id="content">
            ...
            <div class="boderListHome">
               ...
               <div class="title">
                   ...
                   <h1 style="text-align: center;">Thống kê quản lý Chi Tiết Sản Phẩm</h1>
                   <div style="width: 80%; margin: auto;">
                       <div>
                           <button id="barChartButton">Biểu đồ Bar</button>
                           <button id="lineChartButton">Biểu đồ Line</button>
                           <button id="pieChartButton">Biểu đồ Pie</button>
                       </div>
        ...
        $.getJSON('/chiTietSanPham/thongke-data', function(data) {
            ...
            new Chart(ctx, {
                ...
                options: {
                    ...
                    barPercentage: 0.5, // Tỷ lệ chiều rộng cột so với khoảng cách giữa các cột
                    categoryPercentage: 0.7, // Tỷ lệ chiều rộng cột so với khoảng cách giữa các nhóm cột
                }
            });
        });
    });
