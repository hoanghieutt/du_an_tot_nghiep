        ...
        <div id="content">
            ...
            <sf:form action="${action}" method="post"
                ...
                <div class="container">
                            ...
                            <h1 style="text-align: center; color: black;margin-top: 30px; margin-bottom: 50px">Quản lý Hình thức thanh toán</h1>
                ...
                <!-- Footer -->
                <footer style="margin-top: 320px" class="sticky-footer bg-white">
