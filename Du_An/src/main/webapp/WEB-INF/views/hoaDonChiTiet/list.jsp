...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="listHoaDonChiTiet">

                <h3 style="text-align: center; color: black; margin-top: 100px; margin-bottom: 100px">Dữ liệu bảng hóa đơn chi tiết</h3>

                <table class="table" style="margin-bottom: 30px">
                    <thead>
                    <tr>
                        <th scope="col" style="text-align: center">#</th>
<%--                        <th scope="col" style="text-align: center">Mã HĐCT</th>--%>
                        <th scope="col" style="text-align: center">Mã HĐ</th>
                    ...
                    <tbody>
                    <c:forEach var="hdct" items="${listHoaDonChiTiet}" varStatus="i">
                        <tr>
                            <th style="padding-top: 40px; text-align: center" scope="row">${i.index+1}</th>
<%--                            <td style="padding-top: 55px; text-align: center">${hdct.maHDCT}</td>--%>
                            <td style="padding-top: 55px; text-align: center">${hdct.maHD.maHD}</td>
                            <td style="padding-top: 55px; text-align: center">${hdct.mactsp.mactsp}</td>
                            <td style="padding-top: 55px; text-align: center">${hdct.soLuong}</td>
                            <td style="padding-top: 55px; text-align: center">${hdct.donGia}</td>
                            <td style="padding-top: 55px; text-align: center">${hdct.ngayTao}</td>
            ...
            <!-- Footer -->
        <footer style="margin-top: 80px" class="sticky-footer bg-white">
