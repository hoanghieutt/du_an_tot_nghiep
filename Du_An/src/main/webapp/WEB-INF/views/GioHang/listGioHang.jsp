    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div>
                ...
                <c:if test="${not messess1.isEmpty()}">
                    <div class="alert alert-success text-center">
                            ${messess1}
                    </div>
                </c:if>

                <%--    <c:if test="${not messess2.isEmpty()}">--%>
                <%--        <div class="alert alert-success text-center">--%>
                <%--                ${messess2}--%>
                <%--        </div>--%>
                <%--    </c:if>--%>

                <c:if test="${not gioHang.isEmpty()}">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                        <c:forEach items="${gioHang}" var="sp" varStatus="i">
                            <tr>
                                <td>${i.index + 1}</td>
                                <td> ${gioHang.chiTietSanPham.sanpham.tensp} </td>
                                <td>
                                    <form  >

                                        <button type="submit" name="actions" value="giam">-</button>
                                        <input aria-label="soLuong" class="input-qty" max="" min="0" type="number"
                                ...
                                <td>haha</td>
                                <td>
                                    <a href="" class="btn bg-danger mt-2">
                    ...
                    <h3>Total: </h3>
                    <a href="" class="btn btn-success"><i class="fa fa-shopping-cart"></i>Mua hàng</a>
