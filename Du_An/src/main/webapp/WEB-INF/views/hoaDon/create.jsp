    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="Create">
                ...
                <h1 style="text-align: center; color: black">Create hóa đơn</h1>

                <frm:form
                          modelAttribute="hoaDons"
                          action="${pageContext.request.contextPath}/HoaDon/create"
                          method="post"
                          enctype="multipart/form-data">

                    <div class="row">
                        <div class="col-6">
                            <label style="margin-left: 30px">Mã hóa đơn</label>
                            <frm:input path="maHD"/>
                            <p style="color: red">${er}</p>
                        </div>
                        <div class="col-6">
                            <label>Ghi chú</label>
                            <frm:input path="ghiChu"/>
                        </div>
                        <div class="col-6">
                            <label>Ngày tạo</label>
                            <frm:input path="ngayTao" type="Date"/>
                        </div>
                        <div class="col-6">
