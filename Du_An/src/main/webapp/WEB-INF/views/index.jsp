...
<%--                    <a class="collapse-item" href="/404">Login</a>--%>
        ...
        <li class="nav-item">
            <a class="nav-link" href="/gioHang/checkout">
...
<%--            <h3 style="text-align: center">Thông tin Product</h3>--%>
            ...
            <div class="boderListHome">
                ...
                <h1 style="text-align: center; color: black; margin-top: 50px">Featured Product</h1>
                ...
                <div class="container d-flex">
                    <div class="col-sm-8">
                        <div class="row">
                                        ...
                                        <c:forEach var="sanpham" items="${listPage}">
                                            <c:if test="${sanpham.soLuong > 0}">
                                                <a class="col-sm-4" href="${pageContext.request.contextPath}/chiTietSanPham/detailChiTietSanPham/${sanpham.mactsp}">
                                                    <div class="card" style="width: 300px;margin-left: 30px" id="cardHomeList">
                                                        <img class="card-img-top" alt="..." class="img_upload_file" width="20%"  style="margin-top: 7px; height: 200px"
                                                             src="${pageContext.request.contextPath}/upload/${sanpham.image}">
                                                        <div class="card-body" >
                                                        <span class="card-title" style="text-align:center; margin-left: 35px">
                                                            Số lượng: ${sanpham.soLuong}
                                                        </span>
                                                        </div>
                                                        <span class="card-text" style="text-align: center; color: black">Tên sản phẩm : ${sanpham.sanpham.tensp}</span>
                                                    </div>
                                                </a>
                                            </c:if>
                                        </c:forEach>
