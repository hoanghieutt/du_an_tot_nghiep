    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div>
                ...
                <h1 style="text-align: center; color: black; margin-top: 30px; margin-bottom: 60px">Thêm dữ liệu bảng sản phẩm</h1>

                <frm:form
                        modelAttribute="product"
                        action="${pageContext.request.contextPath}/sanPham/create"
                        method="POST"
                ...
                <div class="row">
                    <div class="col-6">
                        <label style="margin-left: 30px">Mã sản phẩm</label>
                        <frm:input path="masp" cssStyle="width: 300px;"  value=""/>
                         <div class="textTitle"><frm:errors cssStyle="margin-left: 40px; color: red" class="errors" path="masp" /></div>
                    </div>
                    <div class="col-6">
                        <label style="margin-left: 150px; margin-right: 30px; margin-bottom: 30px">Tên sản phẩm</label>
                        <frm:input path="tensp" cssStyle="width: 200px;"  value=""/>
                        <div class="textTitle"><frm:errors cssStyle="margin-left: 140px; color: red" class="errors" path="tensp" /></div>
                    </div>
...
<%--                    <div class="col-6">--%>
<%--                        <label style="margin-left: 20px" >Ngày sửa</label>--%>
<%--                        <frm:input path="ngaysua" type="date"  value=""/>--%>
<%--                            &lt;%&ndash;                                <div class="textTitle"><frm:errors cssStyle="margin-left: 400px; color: red" class="errors" path="name" /></div>&ndash;%&gt;--%>
