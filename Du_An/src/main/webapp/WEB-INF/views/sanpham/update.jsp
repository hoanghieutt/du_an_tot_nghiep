...
<%--    <link rel="icon" href="img/background_title.jpg" type="image/x-icon">--%>
    <title>Update dữ liệu bảng sản phẩm</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div>
                ...
                <h1 style="text-align: center; color: black; margin-top: 50px; margin-bottom: 70px">Update dữ liệu bảng sản phẩm</h1>


                <frm:form action="${action}" method="post" modelAttribute="sp">
                    ...
                    <div class="row">
                      ...
                      <div class="col-6">
                                <label style="margin-left: 150px" >Ngày sửa</label>
                                <frm:input cssStyle="margin-left: 63px; width: 200px;" path="ngaysua" type="date"  value=""/>
                                <%--                                <div class="textTitle"><frm:errors cssStyle="margin-left: 400px; color: red" class="errors" path="name" /></div>--%>
                      </div>
                        <div class="col-6">
                            <label style="margin-left: 140px; margin-right: 25px; margin-bottom: 50px">Trạng thái</label>
                            <frm:select path="trangthai" cssStyle="width: 250px; margin-left: 10px">
                                <option value="1">
                                    Còn hàng
                                </option>
                                <option value="0">
                        ...
                        <div>
                            <button type="submit" onclick="if(!confirm('Bạn chắc chắn muốn update không ?')){return false;}else{return true;}" style="margin-left: 400px; margin-bottom: 220px" class="btn btn-primary">Update</button>
