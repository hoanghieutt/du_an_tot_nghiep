    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div>
                ...
                <a class="col-sm-4" href="${pageContext.request.contextPath}/sanPham/create"><button class="btn btn-primary" style="margin-bottom: 30px">Create</button></a>
                <a class="col-sm-4" href="${pageContext.request.contextPath}/sanPham/exportFilePDF"><button class="btn btn-primary" style="margin-bottom: 30px">Xuất file pdf</button></a>
                <a class="col-sm-4" href="${pageContext.request.contextPath}/sanPham/exportFileExcel"><button class="btn btn-primary" style="margin-bottom: 30px">Xuất file excal</button></a>
                ...
                <table class="table">
                    ...
                    <tbody>
                    <c:forEach var="sp" items="${products}" varStatus="i">
                        <tr>
                            <th style="padding-top: 40px" scope="row">${i.index+1}</th>
                            <td style="padding-top: 55px; text-align: center">${sp.masp}</td>
                            <td style="padding-top: 55px; text-align: center">${sp.tensp}</td>
                            ...
                            <td>
                                ...
                                <a class="" href="${pageContext.request.contextPath}/sanPham/delete/${sp.masp}"><button class="btn-primary " onclick="if (!confirm('Bạn chắc chắn có muốn xóa không ?')){return false;}else{return true}">Delete</button></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
