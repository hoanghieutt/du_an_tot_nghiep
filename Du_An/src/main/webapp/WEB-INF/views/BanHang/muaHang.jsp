                    ...
                    <div class="col-6" style="left: 60px">
                        <div class="form_khachHang">
                            ...
                            <frm:form action="/thanhToan/thanhCong" method="post">
                                ...
                                <div class="col-md-12">
                                    <label style="margin-top: 10px">Số tiền cần thanh toán ( VNĐ )</label>
                                ...
                                <div class="col-md-12">
                                    <label style="margin-top: 10px">Số tiền khách hàng đưa ( VNĐ )</label>
                                    <input type="number" class="form-control" name="tienKhachDua" min="${tong}" required>
                                </div>

<%--                                <div class="col-md-12">--%>
<%--                                    <label style="margin-top: 10px">Số tiền thừa</label>--%>
<%--                                    <input type="text" class="form-control" name="tienThua" value="${tienThua} VND" disabled>--%>
<%--                                </div>--%>
...
<%--                                                    ${sp.mactsp.giaban * sp.soLuong}--%>
                                    ...
                                    <div>
                                        <h5 style="color: red; margin-left: 200px; margin-top: 30px">
