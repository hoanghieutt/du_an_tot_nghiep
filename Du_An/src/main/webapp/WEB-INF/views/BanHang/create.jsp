...
<%--                                <p>${error.sanpham}</p>--%>
                            ...
                            <div class="col-6">
                                <label style="margin-left: 30px">Giá nhập VNĐ </label>
                                <frm:input path="gianhap" cssStyle="width: 300px;"  value="${formattedGianhap}" />
...
<%--                            </div>--%>
                            ...
                            <div class="col-6">
                                <label style="margin-left: 30px">Giá bán ( VNĐ ) </label>
                                <frm:input path="giaban" min="${gianhap}"  cssStyle="width: 300px;"  value="${formattedGiaban}"/>
                                <p>${er2}</p>
                            </div>
