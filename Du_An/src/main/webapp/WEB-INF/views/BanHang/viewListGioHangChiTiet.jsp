...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="banHang">
                <h3 style="text-align: center; color: black">Thông tin về giỏ hàng chi tiết !</h3>
                <div class="GioHang">
        ...
        <%--                        <th scope="col" style="text-align: center">Ngày sửa</th>--%>
                            ...
                            <tbody>
                            <c:forEach var="sp" items="${ghct}" varStatus="i">
                                <tr>
                                    <th style="padding-top: 40px" scope="row">${i.index+1}</th>
                                    <td style="padding-top: 37px; text-align: center">${sp.mactsp.sanpham.tensp}</td>
<%--                                    <td style="padding-top: 55px; text-align: center">${sp.soLuong}</td>--%>
<%--                                    Todo code update số lượng--%>
                                    <td>
                                        <form style="top: 40px; margin-top: 20px; margin-left: 70px" action="/gioHang/updateSoLuong/${sp.maGHCT}" method="post">
                                            <button type="submit" name="actions" value="giam">-</button>
                                            <input aria-label="soLuong" class="input-qty" max="${sp.mactsp.soLuong}" min="0" type="number"
                                    ...
                                    <td >
                                        <p style="margin-top: 20px; text-align: center">
                                            <fmt:formatNumber type="" value="${sp.mactsp.giaban}" pattern="#,##0.###" /> VNĐ
                                        </p>
                                    </td>

                                <%--                                    <td style="padding-top: 55px ;text-align: center">${sp.mactsp.giaban}</td>--%>
                                    <td >
                                                <p style="margin-top: 20px; text-align: center">
                                                    <fmt:formatNumber type="" value="${sp.mactsp.giaban * sp.soLuong}" pattern="#,##0.###" /> VNĐ
                                                </p>
                                    </td>
                                    <td style="padding-top: 30px; text-align: center">${sp.trangThai==0 ? "Chưa thanh toán" : "Thanh toán"}</td>
                                    <td>
                                        <a class="" href="${pageContext.request.contextPath}/gioHang/delete/${sp.maGHCT}"><button style="margin-top: 10px" class="btn btn-primary " onclick="if (!confirm('Bạn chắc chắn có muốn xóa không ?')){return false;}else{return true}">Delete</button></a>
                                    </td>
                    ...
                    <div class="ThanhToan">
                        <h4 style="color: red; margin-left: 20px; margin-top: 30px">Tổng tiền:

                            <fmt:formatNumber type="" value="${tongTien}" pattern="#,##0.###" /> VNĐ

                        </h4>

                        <a href="/gioHang/checkout">
                            <button style="margin-left: 20px; margin-top: 30px" class="btn btn-primary">Mua hàng</button>
                        </a>
                    </div>
