...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="bill_dat_hang">

                <div class="alert alert-success text-center">
                    ${mess}
                </div>
                <div class="order" style="border: 1px solid gray; width: 500px; margin-left: 450px; margin-top: 70px; margin-bottom: 60px;">
                    <br>
                    <h2 style="text-align: center;">Thong tin don hang</h2>
                    <br>
                    <br>
                    <p style="margin-left: 100px;"><strong style="text-align: center;">Ma don hang:</strong> ${hoaDon.maHD}</p>
                    <p style="margin-left: 100px;"><strong>Thanh tien:</strong>

                        <fmt:formatNumber type="" value="${tong}" pattern="#,##0.###" /> VNĐ

                        <span>VND</span></p>
                    <p style="margin-left: 100px;"><strong>Ten nguoi nhan:</strong> ${hoaDon.tenNguoiNhan}</p>
                    <p style="margin-left: 100px;"><strong>Dia chi nhan hang:</strong> ${hoaDon.diaChiNhanHang}</p>
                    <p style="margin-left: 100px;"><strong>So dien thoai:</strong> ${hoaDon.soDienThoai}</p>
                    <p style="margin-left: 100px;"><strong>Tien thua:</strong> ${tienThua} VNĐ</p>
                    <p style="margin-left: 100px;"><strong>Ngay tao:</strong> ${hoaDon.ngayTao}</p>
            ...
            <div class="">
                ...
                <a href="/your-controller-path/inHoaDon/${hoaDon.maHD}" target="_blank">

                    <button class="btn btn-primary" style="margin-left: 620px;">
...
<script>
    function inHoaDon(maHD) {
        $.ajax({
            url: "/your-controller-path/inHoaDon/" + maHD,
            type: "GET",
            success: function (data) {
                // Tạo một blob từ dữ liệu PDF
                var blob = new Blob([data], { type: "application/pdf" });

                // Tạo một URL cho blob và hiển thị nó trong một tab mới
