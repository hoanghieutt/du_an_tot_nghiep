...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            ...
            <frm:form modelAttribute="user" action="${pageContext.request.contextPath}/login" method="POST" class="login100-form validate-form">
...
<%--                    <div class="textTitle"><frm:errors class="errors" path="email" /></div>--%>
                ...
                <div class="text-center p-t-136">
                    <a class="txt2" href="/addAccountUser">
                        Create your Account
